        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          {sessionExpired && (
            <div className="flex items-start gap-3 p-3 rounded-lg bg-[#f59e0b]/10 border border-[#f59e0b]/30">
              ...
              <p className="text-sm text-[#f1f0f5]">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#f1f0f5]">Bienvenido de vuelta</h1>
            <p className="text-sm text-[#9896a8] mt-1">Continúa tu racha de hoy</p>
          </div>
