...
export default function QuickStudyCta() {
  ...
  return (
    <RoleGuard permission="finish:review" fallback={null}>
      <div className="bg-gradient-to-br from-[#f97316]/10 to-[#7c3aed]/10 border border-[#2a2b38] rounded-xl p-5">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#f97316] to-[#7c3aed] flex items-center justify-center">
            <BookOpen className="w-4 h-4 text-white" />
          </div>
          <div>
            <p className="text-sm font-semibold text-[#f1f0f5]">¿Listo para estudiar?</p>
            <p className="text-xs text-[#9896a8]">Gana XP y mantén tu racha</p>
          </div>
        </div>
